...
#pick_condition = lambda x: (comm_ids[x]==114)
pick_condition = lambda x: (comm_sizes[comm_ids[x]]>=50)
colour_condition = lambda x: (comm_sizes[comm_ids[x]]>=50)
...
newatt_f = open("attractors_pick.dat","w")
